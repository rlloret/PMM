...
public class PantallaDos extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (variable.equals("Triangulo")) {
            setContentView(new DibujoTriangulo(this));
    ...
    class DibujoTriangulo extends View {
        public DibujoTriangulo(Context c) {
            super(c);
        }
        protected void onDraw(Canvas lienzo) {
          ...
          miPincel.setARGB(255,255,0,0);
            ...
            //lienzo.drawLine(10,10,60,30, miPincel);
            //lienzo.drawLine(60,30,120,10, miPincel);
            //lienzo.drawLine(120,10,10,10, miPincel);
            lienzo.drawLine(50,5,5,50, miPincel);
            lienzo.drawLine(50,5,100,50, miPincel);
            lienzo.drawLine(5,50,100,50, miPincel);
            lienzo.drawLine(50,50,50,100, miPincel);
            lienzo.drawRect(5, 100, 150, 150, miPincel);
            lienzo.drawCircle(120, 150 ,20, miPincel);
            lienzo.drawCircle(40, 150 ,20, miPincel);
